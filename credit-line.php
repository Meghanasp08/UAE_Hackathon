...
<head>
  ...
  <link rel="stylesheet" href="css/smartpay-rules.css"/>
  <script>
...
<body>
  ...
  <!-- Add Rule Modal -->
  <div id="ruleModal" class="modal rule-modal" role="dialog" aria-modal="true" aria-labelledby="ruleModalTitle" hidden>
    <div class="modal-content large">
      ...
      <div class="modal-body" id="ruleModalBody">
        <!-- Rule selection view (default) -->
        <div id="ruleSelectView">
          <div class="rule-list-grid">
            <div class="prebuilt-rule-card" data-rule="aiSmartRepay">
              <div class="rule-icon">🤖</div>
              <div class="rule-title">AI Smart Repay</div>
              <div class="rule-meta">AI detects surplus balance</div>
              <div class="rule-action">Auto-transfer to credit repayment</div>
              <div class="rule-example">"AI noticed extra funds → repaid AED 2,000 from Smart Credit."</div>
            </div>
            <div class="prebuilt-rule-card" data-rule="weekendSweep">
              <div class="rule-icon">⏰</div>
              <div class="rule-title">Weekend Sweep</div>
              <div class="rule-meta">Every Friday 6 PM</div>
              <div class="rule-action">Move extra balance to credit repayment</div>
              <div class="rule-example">"Weekend sweep complete — AED 3,000 paid towards your loan."</div>
            </div>
            <div class="prebuilt-rule-card" data-rule="dailyRepayRule">
              <div class="rule-icon">🌙</div>
              <div class="rule-title">Daily Repay Rule</div>
              <div class="rule-meta">Every day at 10 PM</div>
              <div class="rule-action">If balance > AED 10,000 → auto-repay part of credit</div>
              <div class="rule-example">"SmartRepay transferred AED 1,500 from your account."</div>
            </div>
            <div class="prebuilt-rule-card" data-rule="aiSaveBoost">
              <div class="rule-icon">💡</div>
              <div class="rule-title">AI Save Boost</div>
              <div class="rule-meta">AI detects lower spending this week</div>
              <div class="rule-action">Move part of unused amount to savings</div>
              <div class="rule-example">"Spending lower than usual — AED 500 saved automatically."</div>
            </div>
          </div>
        </div>
        <!-- Rule details view (hidden by default) -->
        <div id="ruleDetailView" hidden>
          <div class="rule-detail-content">
            <div class="rule-detail-header">
              <div class="rule-detail-icon" id="detailIcon"></div>
              <div class="rule-detail-title" id="detailTitle"></div>
            </div>
            <div class="rule-detail-section">
              <div class="section-label">When it triggers:</div>
              <div class="rule-detail-meta" id="detailMeta"></div>
            </div>
            <div class="rule-detail-section">
              <div class="section-label">What it does:</div>
              <div class="rule-detail-action" id="detailAction"></div>
            </div>
            <div class="rule-detail-section">
              <div class="section-label">Example scenario:</div>
              <div class="rule-detail-example" id="detailExample"></div>
            </div>
            <div class="rule-detail-benefits" id="detailBenefits">
              <div class="section-label">Benefits:</div>
              <ul class="benefits-list" id="detailBenefitsList"></ul>
            </div>
          </div>
          <div class="rule-detail-actions">
            <button class="btn-primary" id="confirmRuleBtn">Add This Rule</button>
            <button class="btn-outline" id="backToRuleListBtn">Back</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="js/smartpay-rules.js?v=<?php echo time(); ?>"></script>
